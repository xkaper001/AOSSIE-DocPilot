...
- Flutter SDK installed (see [Setup Guide](./docs/SETUP.md))
...
### 🐛 Reporting Bugs
- Check if the bug has already been reported in [Issues](https://github.com/xkaper001/DocPilot/issues)
...
### 🚀 Suggesting Features
- Check existing [Issues](https://github.com/xkaper001/DocPilot/issues) for similar requests
...
- 💬 Join our discussions in [GitHub Discussions](https://github.com/xkaper001/DocPilot/discussions)
- 🐛 Report issues in [GitHub Issues](https://github.com/xkaper001/DocPilot/issues)
